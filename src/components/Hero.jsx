    ...
    <div className="relative min-h-screen text-gray-100">
      <main className="relative z-10">
        ...
        <section className="bg-gradient-to-b from-black via-neutral-800 to-gray-950 mx-auto px-4 pt-16 pb-8 md:py-20 text-center flex flex-col lg:flex-row  gap-x-12 lg:justify-center">
          <div className="flex-col flex justify-start gap-10 lg:py-8 mx-8 lg:mt-16 relative">
            <div className="flex flex-col gap-8 justify-center py-2 items-center w-full ">
              <span className="text-6xl font-black lg:text-8xl">CERTIFY.do</span>
        ...
        <section className="bg-black/80 py-16">
          <div className="max-w-5xl mx-auto px-4 grid gap-8 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex flex-col items-center text-center gap-4 p-4 rounded-lg bg-neutral-800 hover:shadow-lg transition duration-300"
              >
